<template>
  <div class="wl-app">
    <header class="header">
      <h2>Formularz na frakcję EMS</h2>
    </header>
    <main>
      <article class="form" id="form">
          ...
          <div class="form__element--medium">
            <form>
              <div class="form__element-label">
                <b>IC</b> | Pełniłeś już kiedyś rolę EMS?
              </div>
              <textarea
                type="text"
                class="form__element-input"
                v-model="act"
                placeholder="Opisz swoją dawną rolę w EMS jeżęli takową pełniłeś."
              ></textarea>
            </form>
          </div>
          <div class="form__element--medium">
            <form>
              <div class="form__element-label">
                <b>IC</b> | Co możesz wnieść do EMS?
              </div>
              <textarea
                type="text"
                class="form__element-input"
                v-model="bring"
                placeholder="Co jesteś w stanie wnieść do EMS"
              ></textarea>
            </form>
          </div>
        </section>
        <section class="form-half">
          ...
          <div class="form__element--medium">
            <form>
              ...
              <textarea
                ...
                class="form__element-input"
                v-model="whyU"
                placeholder="Dlaczego ty powinieneś być w frakcji EMS?"
              ></textarea>
            </form>
          </div>
          <div class="form__element--medium">
          ...
          <div class="form__element--medium">
            <form>
              <div class="form__element-label">
                <b>OOC</b> | Doświadczenie w frakcji EMS
              </div>
              <textarea
                type="text"
                class="form__element-input"
                v-model="experience"
                placeholder="Doświadczenie w frakcji EMS"
              ></textarea>
            </form>
          </div>
          <div class="form__element">
    ...
    submit() {
      ...
      validationLength(
        ...
        [
          ...
          '<br /> Musisz podać czy pełniłeś już kiedyś role w EMS',
          '<br /> Musisz podać co wniesiesz do frakcji',
          '<br /> Akcja z /me i /do musi zawierać co najmniej 20 znaków',
          '<br /> Musisz podać dlaczego ty powinieneś być w frakcji EMS',
          '<br /> Musisz podać swoje doświadczenie w frakcji EMS',
